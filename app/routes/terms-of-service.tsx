...
export function meta({ data }: Route.MetaArgs) {
  ...
  const title = "Terms of Service | AllSavingsCalculators";
  const description =
    "Terms that govern your use of AllSavingsCalculators. Includes acceptable use, disclaimers, and limitations of liability.";
...
export default function TermsOfService() {
  return (
    <SimplePageShell
      ...
      subtitle="The rules and disclaimers that apply when using AllSavingsCalculators tools."
    >
      <div className="my-8 flex flex-col mx-10 items-center justify-center gap-8 font-nunito text-skull-brown">
        <header className="flex max-w-[1200px] flex-col gap-5 w-full">
          ...
          <p className="flex flex-col gap-4 py-2">
            We are AllSavingsCalculators (https://www.allsavingscalculators.com)
            ("Company", "we", "us", "our").
          </p>

          <p>
            We operate the website https://www.allsavingscalculators.com (the
          ...
          <p>
            You can contact us by email at admin@allsavingscalculators.com or by
            mail to https://www.allsavingscalculators.com, Toronto, Ontario,
            Canada.
          </p>
          ...
          <p>
            ...
            and AllSavingsCalculators, concerning your access to and use of the
        ...
        <main className="flex max-w-[1200px] flex-col gap-8">
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              provided when using the Services is not intended for distribution
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              admin@allsavingscalculators.com. If we ever grant you the
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              jurisdiction in which you reside (or, if you are, you have the
              involvement and consent of a parent or legal guardian); (5) you
              ...
              the Services for any illegal or unauthorized purpose; and (7) your
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              You may be required to register to use the Services (for example,
              if we introduce optional accounts, subscriptions, or paid content
              in the future). You agree to keep your password confidential and
            ...
            <p>
              Using profanity in the username, in any way, shape, or form, is
              not allowed. Doing so may result in the username being changed by
              the AllSavingsCalculators admin or, in extreme cases, may lead to
              account suspension or termination. If you notice any users abusing
              this policy please contact us at admin@allsavingscalculators.com
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              subscriptions, or paid content in the future, we may accept
              payment through third-party payment processors (for example,
              Stripe). The payment methods available will be shown at checkout.
            </p>
            <p>
              ...
              may be added where required. We may change prices at any time.
              Currency will be disclosed at checkout.
            </p>
            <p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              All sales are final and no refund will be issued, unless required
              by applicable law or unless a separate written refund policy is
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              Policy: https://www.allsavingscalculators.com/privacy. By using
              ...
              Services may be hosted in Canada and/or other jurisdictions
              depending on our service providers. If you access the Services
              ...
              the Services, you are transferring your data to Canada, and you
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              (a "Notification"). A copy of your Notification may be sent to the
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              laws of Canada and the Province of Ontario. AllSavingsCalculators
              and yourself irrevocably consent that the courts of Ontario,
              Canada shall have exclusive jurisdiction to resolve any dispute
              which may arise in connection with these Legal Terms, except as
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              least thirty (30) days before initiating court proceedings. Such
            ...
            <p>
              Unless required by applicable law, you and we agree that any
              dispute arising out of or in connection with these Legal Terms
              will be resolved in the courts located in Ontario, Canada, and
            ...
            <p>
              ...
              the above provisions concerning informal negotiations: (a) any
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>Toronto, Ontario</p>
            <p>Canada</p>
            <p>admin@allsavingscalculators.com</p>
          </section>
        </main>
      </div>
    </SimplePageShell>
