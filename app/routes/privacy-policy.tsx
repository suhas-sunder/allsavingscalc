...
export function meta({ data }: Route.MetaArgs) {
  ...
  const title = "Privacy Policy | AllSavingsCalculators";
  const description =
    "Read how AllSavingsCalculators handles information, cookies, and third-party advertising. This policy explains what is collected and why.";
...
export default function PrivacyPolicy() {
  return (
    <SimplePageShell
      ...
      subtitle="How data is handled when you use AllSavingsCalculators tools, including cookies and advertising partners."
    >
      <>
          ...
          <div className="max-w-[1180px] mx-auto px-4 pt-6 pb-12">
            ...
            <header className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <div className="mt-5 space-y-4 text-slate-700 leading-relaxed">
                <p>
                  <span>
                    This privacy notice forAllSavingsCalculators
                    (https://www.allsavingscalculators.com) ("we", "us", or
                  ...
                  <ul className="mt-4 list-inside list-disc flex flex-col gap-2 pl-5">
                    <li>
                      ...
                      https://www.allsavingscalculators.com, or any website of
                ...
                <p className="space-y-1">
                  <span className="block">
                    Data controller:AllSavingsCalculators is responsible for deciding how your
                    personal information is processed for the purposes described
                    in this privacy notice.
                  </span>
                  <span className="block">
                    Contact: admin@allsavingscalculators.com (Toronto, Ontario,
                    Canada).
                  </span>
                </p>
              </div>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <Section title="1. WHAT INFORMATION DO WE COLLECT?">
                  ...
                  <p>
                    ...
                    to us when you register on the Services (if we offer
                    optional accounts in the future), express an interest in
                  ...
                  <p>
                    ...
                    your payment instrument. If we offer payments,
                    subscriptions, or paid content, payment processing may be
                    handled by third-party payment processors (such as Stripe).
                    We do not store full payment card details on our servers.
                    You may find Stripe’s privacy notice here:{" "}
                    <a
                  ...
                  <p>
                    ...
                    media account. If you choose to register in this way, we
                    will collect the information described in the section called
                    "HOW DO WE HANDLE YOUR SOCIAL LOGINS?" below.
                  </p>

                  <p>
                    Affiliate Links and Referrals. We may include affiliate
                    links on our Services. If you click an affiliate link and
                    make a purchase, we may receive a commission. Affiliate
                    partners may use cookies or similar technologies to track
                    referrals according to their own privacy policies.
                  </p>

                  <p>
                    Merch and Third-Party Stores. We may link to third-party
                    stores or platforms where merchandise or digital products
                    can be purchased. Any purchase you make through a
                    third-party store is governed by that third party’s terms
                    and privacy policy.
                  </p>
                  ...
                  <p>
                    ...
                    device name, country, approximate location, information
                    about how and when you use our Services, and other technical
                    information. This information is primarily needed to
                    maintain the security and operation of our Services, for
                    analytics, and for advertising measurement and fraud
                    prevention.
                  </p>
                  ...
                  <p>
                    ...
                    https://www.allsavingscalculators.com/cookies.
                  </p>

                  <p>
                    Analytics. We use PostHog to help us understand usage and
                    improve the Services. PostHog may collect information such
                    as your device and browser details, pages viewed,
                    interactions, and approximate location (based on IP).{" "}
                    <span>
                      If available, you may be able to limit analytics
                      collection via cookie preferences or browser settings.
                    </span>
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      Location Data. We may collect approximate location data
                      (for example, based on IP address) and, if you enable it
                      on your device and our Services request it, more precise
                      location data. You can opt out of precise location sharing
                      by refusing access or disabling your Location setting. If
                    ...
                    <li>
                      ...
                      address, and ad interaction events) to provide, measure,
                      and improve advertising, limit ad frequency, and help
                      detect fraud.
                    </li>
                  </ul>
                </Section>
                ...
                <Section title="2. HOW DO WE PROCESS YOUR INFORMATION?">
                  ...
                  <ul>
                    ...
                    <li>
                      To deliver and measure advertising, including contextual
                      and personalized ads where permitted by law and settings.
                    </li>
                    <li>
                ...
                <Section title="4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?">
                  ...
                  <ul>
                    ...
                    <li>
                      Affiliate partners when you click affiliate links or make
                      a purchase via a referral link.
                    </li>
                    <li>
                      Merch or fulfillment partners and third-party storefronts
                      if we offer merchandise.
                    </li>
                    <li>
                ...
                <Section title="5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?">
                  ...
                  <p>
                    ...
                    with us. We do not control those third parties and are not
                    responsible for their content, policies, or practices. We
                    recommend you review the privacy policies of any third-party
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      partners to serve ads to users based on their visit to
                    ...
                    <li>
                      ...
                      cookies (including advertising cookies) before they are
                      set.
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    purchases. The handling of that data is governed by the
                ...
                <Section title="6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?">
                  ...
                  <p>
                    ...
                    Notice: https://www.allsavingscalculators.com/cookies.
                  </p>
                  <p>
                ...
                <Section title="7. HOW LONG DO WE KEEP YOUR INFORMATION?">
                  ...
                  <p>
                    ...
                    permitted by law. For example, if we introduce accounts in
                    the future, we typically keep account information while your
                    account is active. We may retain certain information for
                    security, fraud prevention, compliance, and legitimate
                    business purposes.
                  </p>
                </Section>
                ...
                <Section title="8. DO WE COLLECT INFORMATION FROM MINORS?">
                  ...
                  <p>
                    ...
                    contact us at admin@allsavingscalculators.com and we will
                    take appropriate steps to delete the information.
                  </p>
                </Section>
                ...
                <Section title="9. WHAT ARE YOUR PRIVACY RIGHTS?">
                  ...
                  <p>
                    ...
                    admin@allsavingscalculators.com. We may need to verify your
                    identity before responding. Where applicable, you may also
                    have the right to object to certain processing or request
                ...
                <Section title="10. DO WE MAKE UPDATES TO THIS NOTICE?">
                  ...
                  <p>
                    ...
                    updated" date and will be effective as soon as it is
                    accessible.
                  </p>
                </Section>
                ...
                <Section title="11. CONTACT US">
                  <p>
                    ...
                    email us at admin@allsavingscalculators.com or contact us by
                    post at:
                  </p>
                  <p>https://www.allsavingscalculators.com/</p>
                  <p>Toronto, Ontario</p>
                  <p>Canada</p>
                </Section>
              </div>
  ...
  return (
    <footer className="bg-white border-t border-slate-200">
      <div className="max-w-[1180px] mx-auto px-4 py-6 text-sm text-slate-600 flex items-center justify-between">
        <span>© {new Date().getFullYear()} AllSavingsCalculators.com</span>
