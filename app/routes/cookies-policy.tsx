...
export function meta({ data }: Route.MetaArgs) {
  const canonical =
    data?.canonical ?? "https://www.allsavingscalculators.com/";
  const title = "Cookies Policy | AllSavingsCalculators";
  const description = "Learn how cookies are used on AllSavingsCalculators for functionality, analytics, and advertising, and how to control them.";
...
return (
  <SimplePageShell
    ...
    subtitle="What cookies are used for on AllSavingsCalculators and how you can control them in your browser."
  >
    <>
        ...
        <div className="max-w-[1180px] mx-auto px-4 pt-6 pb-12">
          ...
          <header className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            <div className="mt-5 space-y-4 text-slate-700 leading-relaxed">
              <p>
                This Cookie Policy explains how https://www.allsavingscalculators.com
                ("Company", "we", "us", and "our") uses cookies and similar
                technologies to recognize you when you visit our website at
                https://www.allsavingscalculators.com ("Website"). It explains what these
            ...
            <div className="prose prose-slate max-w-none">
              <Section title="What are cookies?">
                ...
                <p>
                  ...
                  https://www.allsavingscalculators.com) are called "first-party cookies."
              ...
              <Section title="Where can I get further information?">
                <p>
                  ...
                  technologies, please contact us at: admin@allsavingscalculators.com.
                </p>
              </Section>
            </div>
